...
from mobilenet_v2_model import HorizonNet
...
if __name__ == '__main__':
    ...
    parser.add_argument('--backbone', default='resnet50',
                        choices=['resnet18', 'resnet50', 'resnet101', 'mobilenet'],
    ...
    for ith_epoch in trange(1, args.epochs + 1, desc='Epoch', unit='ep'):
        ...
        tottime += terminate_time - start_time
        print("%f초 걸렸습니다. -> 총 %f초" % (terminate_time - start_time,tottime))
        ...
        if ith_epoch % args.save_every == 0:
            save_model(net,
                       ...
                       ith_epoch)
            avgtime = tottime/ith_epoch
            print("평균 %f초 걸렸습니다"% (avgtime))