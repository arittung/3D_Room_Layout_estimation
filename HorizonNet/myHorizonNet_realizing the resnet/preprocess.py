...
parser.add_argument('--rev', default=1, help="img left <-> right")
...
for i_path in paths:
    ...
    rev = 0
    if args.rev:
        i_img = Image.fromarray((i_img * 255).astype(np.uint8)).transpose(Image.FLIP_LEFT_RIGHT)
        rev = 1
