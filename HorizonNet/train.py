...
if __name__ == '__main__':
    ...
    parser.add_argument('--id', default='default_resnet50',
    ...
    parser.add_argument('--train_root_dir', default='mydataset/train',
                        help='root directory to training dataset. '
                             'should contains img, label_cor subdirectories')
    parser.add_argument('--valid_root_dir', default='mydataset/valid',
